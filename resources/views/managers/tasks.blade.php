            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <h4><a href="#" style="text-decoration:none;"><strong><h1>{{ $id->first_name }}</h1>
                                        <h1>{{ $id->last_name }}</h1></strong></a> – <small><small><a href="#" style="text-decoration:none; color:grey;"><i><i class="fa fa-clock-o" aria-hidden="true"></i> <h5>Ultimo inicio de sesion: {{ $id->last_login }}</h5></i></a></small></small></h4>
                    <span>
